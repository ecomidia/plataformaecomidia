<template>
  <q-page class="column">
    ...
    <div class="posts">
      ...
      <masonry-wall class="q-pt-xl" :items="statusStore.tweetsId.slice(0,pagination)" :ssr-columns="1" :column-width="300" :gap="16">
      ...
      <div class="text-center">
        <q-btn label="Carregar Mais" @click="pagination = pagination+3"></q-btn>
